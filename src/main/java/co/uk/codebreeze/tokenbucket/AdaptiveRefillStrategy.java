...
public class AdaptiveRefillStrategy implements RefillStrategy{
    ...
    public AdaptiveRefillStrategy(Semaphore semaphore, Ticker ticker, BigDecimal numTokens, long period, TimeUnit unit, long startTimeInNanos) {
        this.ticker = ticker;
